...
Durante o treino, o agente monitoriza continuamente a pontuação. Quando esta atinge ou ultrapassa $15\,000$ pontos, o treino é interrompido automaticamente, o modelo é guardado e o processo termina. Esta condição garante que o agente não continue a treinar além do necessário.
...
\begin{figure}[H]
    ...
    \caption{Ecrã de fim de jogo com a pontuação máxima obtida durante o treino (55\,260 pontos, alcançada ao longo de 7 episódios / 21 vidas).}
    \label{fig:highscore}
\end{figure}
